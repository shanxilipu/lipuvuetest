...
class HostAccountsLink extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      totalNumber: '',
  ...
  getCatalogue = (value, isSearch) => {
    const params = { sourceType: 2 };
    const { selectedItem } = this.props;
  ...
  fetchParentTree = (queryParm, isSearch) => {
        ...
        >
          <Panel
            header={formatMessage({
              id: 'AserCodeLinkConfig.AssociateWithHostingAccount',
              defaultMessage: '与主机账号关联',
            })}
            key="1"
          >
              ...
              <Row>
                <Col span={7}>
                  <p className={styles.title}>
                    ...
                    {formatMessage({
                      id: 'AserCodeLinkConfig.AllowAccessToHostAccount',
                      defaultMessage: '允许访问主机账号',
                    })}
                  </p>
                  <Card
                    title={
                      <Checkbox checked={allChecked} onChange={this.onCheckAllChange}>
                        {formatMessage({
                          id: 'AserCodeLinkConfig.HostAccount',
                          defaultMessage: '主机账号',
                        })}
                      </Checkbox>
                    }
                    ...
                    <AllowAccessTime
                      ...
                      initialValues={{
                        ...
                        ALLOW_DAY: this.filterData('ALLOW_DAY')
                          ? this.filterData('ALLOW_DAY').split(',')
                          : null,
                      }}
                    />
                  </div>
...
export default HostAccountsLink;
